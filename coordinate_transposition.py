...
# Transform the coordinates to be used by the robot
    ...
    y = min(data[1][right_shoulder], data[1][left_shoulder]) + (abs(data[1][right_shoulder] - data[1][left_shoulder]) / 2)
    ...
    distance_right_wrist_shoulder_center.append([distance_right_wrist_shoulder_center_x, distance_right_wrist_shoulder_center_y, distance_right_wrist_shoulder_center_z])
